  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: cn(
          "relative isolate z-0 rounded-l-(--cell-radius) bg-primary/5 dark:bg-accent after:absolute after:inset-y-0 after:right-0 after:w-4 after:bg-primary/5 dark:after:bg-accent",
          defaultClassNames.range_start,
        ),
        range_middle: cn(
          "relative isolate z-0 bg-primary/5 dark:bg-accent rounded-none",
          defaultClassNames.range_middle,
        ),
        range_end: cn(
          "relative isolate z-0 rounded-r-(--cell-radius) bg-primary/5 dark:bg-accent after:absolute after:inset-y-0 after:left-0 after:w-4 after:bg-primary/5 dark:after:bg-accent",
          defaultClassNames.range_end,
        ),
        today: cn(
          "rounded-(--cell-radius) dark:bg-accent bg-primary/10 text-accent-foreground data-[selected=true]:rounded-none",
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "data-[range-middle=true]:bg-primary/10 data-[range-middle=true]:text-foreground data-[range-middle=true]:dark:bg-accent data-[range-middle=true]:dark:text-accent-foreground data-[range-middle=true]:rounded-none",
        "data-[selected-single=true]:bg-primary data-[selected-single=true]:text-primary-foreground data-[selected-single=true]:rounded-(--cell-radius)",
